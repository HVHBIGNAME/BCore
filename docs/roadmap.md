...
> Обновление 2026-09-13: разработка остаётся на протоколе 775. Текущий приоритет —
> worldgen: реальный межчанковый регион, формы/декораторы деревьев, пещеры/руды,
> структуры и расширение набора сидов. Биомы теперь хранятся в 3D, данные встроены
> в бинарь, добавлены независимые офлайн-эталоны. Подробности и честные границы
> покрытия — в [parity-report.md](parity-report.md); старые оценки высот отозваны.
