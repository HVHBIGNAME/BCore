...
> Состояние на 2026-09-13: рабочий протокол — **775 / 26.1**, 776 — следующая
> миграция. Описание ниже историческое: login/play, команды, стриминг и сохранение
> уже реализованы. Worldgen использует встроенные данные, трёхмерные биомы и
> параллельные колонки; настоящий межчанковый staged scheduler ещё предстоит.
> Актуальные измерения и ограничения: [parity-report.md](parity-report.md).
